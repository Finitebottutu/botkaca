...
LOCAL = Local({
    ...
    'COMMAND_LEECH@msptorrentleechbot2' : 'leech link or magnet',
    'COMMAND_CANCEL_LEECH@msptorrentleechbot2' : 'cancel leeching',
    'COMMAND_LEECH_LIST@msptorrentleechbot2' : 'list on going leech',
    'COMMAND_SET_THUMBNAIL@msptorrentleechbot2' : 'set custom video thumbail',
    'COMMAND_RESET_THUMBNAIL@msptorrentleechbot2' : 'reset custom video thumbnail',
    'COMMAND_UPLOAD_AS_DOC@msptorrentleechbot2' : 'toggle upload anything as document',
    'COMMAND_UPLOAD_AS_ZIP@msptorrentleechbot2' : 'toggle upload anything as bundled zipfile',
    'COMMAND_SET_TRACKER@msptorrentleechbot2' : 'set default tracker, sparated by newline',
    'BLOCK_EMPTY' : "▱",
    "BLOCK_FILLED" : "▰"
})
